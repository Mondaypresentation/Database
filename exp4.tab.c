...
static const yytype_uint16 yyrline[] =
{
     ...
     329,   336,   343,   348,   356,   380,   494,   495,   504,   507,
     511,   515,   520,   522,   526,   530,   536,   542,   549,   554,
     562,   565,   571,   575,   582,   593,   608,   622,   626,   634,
     640,   647
};
#endif
...
#line 357 "exp4.y"
    {
			...
			if(CHECK_TABLE((yyvsp[(3) - (5)].strval)) == 0){//表不存在
				...
				if(is_where == 0){
					...
					delete_rec((yyvsp[(3) - (5)].strval),cond[0].attribute1,cond[0].attribute2);
				}
			}
